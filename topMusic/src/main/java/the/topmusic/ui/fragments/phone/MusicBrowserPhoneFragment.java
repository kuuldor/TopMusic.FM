...
package the.topmusic.ui.fragments.phone;
...
import the.topmusic.adapters.PagerAdapter.MusicFragments;
...
public class MusicBrowserPhoneFragment extends SherlockFragment implements
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        mPagerAdapter.setPageTitles(getResources().getStringArray(R.array.phone_page_titles));
    ...
    public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.flipback, menu);
    }
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_view_as_grid:
                ...
                NavUtils.goHome(getSherlockActivity());
                return true;
            case R.id.menu_fliponline:
                SherlockFragmentActivity activity = getSherlockActivity();
                PreferenceUtils.getInstace(activity).setHomeOnline();
