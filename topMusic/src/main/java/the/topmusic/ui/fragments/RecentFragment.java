...
import the.topmusic.loaders.RecentLoader;
...
import static the.topmusic.utils.PreferenceUtils.RECENT_LAYOUT;
...
public class RecentFragment extends SherlockFragment implements LoaderCallbacks<List<Album>>,
     ...
     */
    private static final int GROUP_ID = FragmentIndex.RECENT_FRAGMENT_IDX;
