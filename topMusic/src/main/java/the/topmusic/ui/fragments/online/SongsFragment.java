...
/**
 * Created by lucd on 11/7/14.
 */
public class SongsFragment extends XMusicListFragment {

    /**
     * Used to keep context menu items from bleeding into other fragments
     */
    private static final int GROUP_ID = FragmentIndex.XSONGS_FRAGMENT_IDX;
...
//                    return true;
    ...
    public void onItemClick(final AdapterView<?> parent, final View view, final int position,
        ...
        XMusicEntry entry = getAdapter().getItem(position);

        if (entry.mMusicEntryType.equalsIgnoreCase("next")) {
            ...
            Song[] songList = getSongList();
            MusicUtils.playAll(getSherlockActivity(), songList, position, false);
        }
    }
    ...
    protected void loadDataIntoAdapter(List<XMusicEntry> data) {
        super.loadDataIntoAdapter(data);
    }
}
