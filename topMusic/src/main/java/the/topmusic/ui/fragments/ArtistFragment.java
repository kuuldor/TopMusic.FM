...
import the.topmusic.adapters.ArtistAdapter;
import the.topmusic.loaders.ArtistLoader;
...
import static the.topmusic.utils.PreferenceUtils.ARTIST_LAYOUT;
...
public class ArtistFragment extends SherlockFragment implements LoaderCallbacks<List<Artist>>,
        ...
        if (item.getGroupId() == GROUP_ID) {
            switch (item.getItemId()) {
                ...
                case FragmentMenuItems.DELETE:
                    ...
                    String[] list = MusicUtils.songListToIDList(mArtistList);

                    DeleteDialog.newInstance(artist, list, artist).show(
    ...
    private int getItemPositionByArtist() {
        final String artistName = MusicUtils.getCurrentArtistId();
