...
import the.topmusic.format.PrefixHighlighter;
...
public class SearchActivity extends SherlockFragmentActivity implements LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (TopMusicUtils.isLandscape(this)) {
    ...
    public void onItemClick(final AdapterView<?> parent, final View view, final int position,
        ...
        if ("artist".equals(mimeType)) {
            ...
            MusicUtils.playAll(this, MusicUtils.getSongListForCursor(cursor), 0, false);
        }
