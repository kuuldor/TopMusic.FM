...
import the.topmusic.ui.fragments.LyricsFragment;
import the.topmusic.ui.fragments.QueueFragment;
import the.topmusic.utils.MusicUtils;
import the.topmusic.utils.MusicUtils.ServiceToken;
import the.topmusic.utils.NavUtils;
import the.topmusic.utils.ThemeUtils;
import the.topmusic.utils.TopMusicUtils;
import the.topmusic.widgets.PlayPauseButton;
import the.topmusic.widgets.RepeatButton;
import the.topmusic.widgets.RepeatingImageButton;
import the.topmusic.widgets.ShuffleButton;

import static the.topmusic.utils.MusicUtils.mService;

/**
 * TopMusic's "now playing" interface.
 * 
...
public class AudioPlayerActivity extends SherlockFragmentActivity implements ServiceConnection,
    ...
    private void updateNowPlayingInfo() {
        ...
        mImageFetcher.loadCurrentArtworkThumbnail(mAlbumArtSmall);
    ...
    private void shareCurrentTrack() {
        ...
        final String shareMessage = getString(R.string.now_listening_to) + " "
                ...
                + MusicUtils.getArtistName() + " " + getString(R.string.hash_topmusic);
