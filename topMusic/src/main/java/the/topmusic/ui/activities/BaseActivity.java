...
public abstract class BaseActivity extends SherlockFragmentActivity implements ServiceConnection {
    ...
    protected void onPause() {
        ...
        if (MusicUtils.isPlaying()) {
            if (TopMusicUtils.isApplicationSentToBackground(this) || mIsBackPressed
    ...
    public void onBackPressed() {
        ...
        if (onBackPressedListener != null) {
            backHandled = onBackPressedListener.doBack();
        }
    ...
    private void updateBottomActionBarInfo() {
        ...
        // Set the album art
        TopMusicUtils.getImageFetcher(this).loadCurrentArtworkThumbnail(mAlbumArt);
    }
    ...
    public interface SearchProvider {
        void searchText(Activity activity, String query);
    }
