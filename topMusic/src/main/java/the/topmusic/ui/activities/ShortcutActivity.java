...
import the.topmusic.loaders.AsyncHandler;
import the.topmusic.loaders.LastAddedLoader;
import the.topmusic.loaders.SearchLoader;
...
import static the.topmusic.Config.MIME_TYPE;
...
public class ShortcutActivity extends SherlockFragmentActivity implements ServiceConnection {
    ...
    private final LoaderCallbacks<List<Song>> mSongAlbumArtistQuery = new LoaderCallbacks<List<Song>>() {
        ...
        public void onLoadFinished(final Loader<List<Song>> loader, final List<Song> data) {
            ...
            // What's about to happen is similar to the above process. TopMusic
            // runs a
