...
package the.topmusic.appwidgets;
...
public class RecentWidgetProvider extends AppWidgetProvider {
    ...
    public static final String CLICK_ACTION = "the.topmusic.recents.appwidget.action.CLICK";

    public static final String REFRESH_ACTION = "the.topmusic.recents.appwidget.action.REFRESH";
    ...
    public void performUpdate(final MusicPlaybackService service, final int[] appWidgetIds) {
        ...
        if (TopMusicUtils.isApplicationSentToBackground(service)) {
