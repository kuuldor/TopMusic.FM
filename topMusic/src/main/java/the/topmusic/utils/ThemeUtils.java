...
/**
 * In order to implement the theme chooser for TopMusic, this class returns a
 ...
 * identifiers are the same as all of TopMusic's resources a little less code is
...
public class ThemeUtils {
    ...
    /**
     * Used to searc the "Apps" section of the Play Store for "TopMusic Themes".
     */
     ...
     */
    public static final String topmusic_PACKAGE = "the.topmusic";
    ...
    public ThemeUtils(final Context context) {
        ...
        try {
            ...
            // TopMusic's.
            setThemePackageName(topmusic_PACKAGE);
        }
    ...
    public final String getThemePackageName() {
        return mPreferences.getString(PACKAGE_NAME, topmusic_PACKAGE);
    }
    ...
    public boolean isActionBarDark() {
        return TopMusicUtils.isColorDark(getColor("action_bar"));
    }
    ...
    public void setOverflowStyle(final Activity app) {
        if (isActionBarDark()) {
            app.setTheme(R.style.TopMusic_Theme_Dark);
        } else {
            app.setTheme(R.style.TopMusic_Theme_Light);
        }
    }
