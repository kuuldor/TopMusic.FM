...
public class ChineseUtils {
     ...
     */
    private static HashMap<Integer, Integer> cht2chsMap = null;
    /**
     * 简体转繁体的映射表
     *
     * @see http
     ...
     * %AF%B9%E5%BA%94%E8%A1%A8
     */
    private static HashMap<Integer, Integer> chs2chtMap = null;
    ...
    private static void initChs2ChtMap() {
        chs2chtMap = new HashMap<Integer, Integer>(3096);
        int[][] chs2chtArr = getChs2chtArr();
        for (int i = 0; i < chs2chtArr.length; i++) {
            int[] cm = chs2chtArr[i];
            ChineseUtils.chs2chtMap.put(cm[0], cm[1]);
        }
    }

    private static void initCht2ChsMap() {
        cht2chsMap = new HashMap<Integer, Integer>(3096);
        int[][] cht2chsArr = getCht2chsArr();
        for (int i = 0; i < cht2chsArr.length; i++) {
            int[] cm = cht2chsArr[i];
            ChineseUtils.cht2chsMap.put(cm[0], cm[1]);
        }
    }
    ...
    public static String cht2chs(String s) {
        StringBuilder build = new StringBuilder();

        for (int i = 0; i < s.length(); i++) {
            int cp = s.codePointAt(i);
            build.append((char) cht2chs(cp));
        }
    ...
    public static String chs2cht(String s) {
        StringBuilder build = new StringBuilder();

        for (int i = 0; i < s.length(); i++) {
            int cp = s.codePointAt(i);
            build.append((char) chs2cht(cp));
        }
        return build.toString();
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < chs2chtArr.length; i++) {
            int[] cm = chs2chtArr[i];
            int codePointCht = ChineseUtils.chs2cht(cm[0]);
            System.out.println("简体：" + new String(new int[]{cm[0]}, 0, 1)
                    + ",繁体："
                    + new String(new int[]{ChineseUtils.chs2cht(cm[0])}, 0, 1)
        ...
        for (int i = 0; i < cht2chsArr.length; i++) {
            int[] cm = cht2chsArr[i];
            int codePointChs = ChineseUtils.cht2chs(cm[0]);
        ...
        for (char c = 0xFF01; c <= 0xff65; c++) {
            System.out.println("全角字符:" + c + ",半角字符：" + ChineseUtils.quan2ban(c));
        }
        for (char c = 0x20; c <= 0x7e; c++) {
            System.out.println("半角字符:" + c + ",全角字符：" + ChineseUtils.ban2quan(c));
        }
