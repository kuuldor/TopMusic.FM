...
import the.topmusic.ui.activities.AudioPlayerActivity;
import the.topmusic.ui.activities.HomeActivity;
import the.topmusic.ui.activities.ProfileActivity;
import the.topmusic.ui.activities.SearchActivity;
import the.topmusic.ui.activities.SettingsActivity;
...
public final class NavUtils {
    ...
    public static void openArtistProfile(final SherlockFragmentActivity context,
        ...
        bundle.putString(Config.ID, MusicUtils.getIdForArtist(context, artistName));
    ...
    public static void openAlbumProfile(final SherlockFragmentActivity context,
        ...
        bundle.putString(Config.ID, MusicUtils.getIdForAlbum(context, albumName));
    ...
    public static void openXMusicEntry(final SherlockFragmentActivity context,
                                       final XMusicEntry entry, String type) {

        // Create a new bundle to transfer the album info
        final Bundle bundle = new Bundle();
        bundle.putString(Config.ID, entry.mMusicEntryId);
        bundle.putString(Config.MIME_TYPE, type);
        bundle.putString(Config.NAME, entry.mMusicEntryName);
        bundle.putString(Config.ENTRY_URL, entry.mUrl);
        bundle.putString(Config.ENTRY_TYPE, entry.mMusicEntryType);
