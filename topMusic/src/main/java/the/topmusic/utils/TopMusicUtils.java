...
import the.topmusic.ui.activities.ShortcutActivity;
import the.topmusic.widgets.ColorPickerView;
 ...
 */
public final class TopMusicUtils {
     ...
     */
    public static ImageFetcher getImageFetcher(final SherlockFragmentActivity activity) {
        final ImageFetcher imageFetcher = ImageFetcher.getInstance(activity);
        boolean diskCacheReadonly = false;
        imageFetcher.setImageCache(ImageCache.findOrCreateCache(activity, diskCacheReadonly));
        return imageFetcher;
    }
     ...
     * @param context The {@link android.content.Context} to use to
     */
    public static void createShortcutIntent(final String displayName, final String id,
        ...
        try {
            ...
            Log.e("TopMusicUtils", "createShortcutIntent - " + e);
            Toast.makeText(
                    context,
                    displayName + " "
    ...
    /**
     * Used to know if TopMusic was sent into the background
     * 
     * @param context The {@link Context} to use
     */
    ...
    public static String appLocale() {
        ...
        if (locale.equals(Locale.CHINESE) || locale.equals(Locale.CHINA)
                || locale.equals(Locale.PRC) || locale.equals(Locale.SIMPLIFIED_CHINESE )
                || locale.equals(Locale.TAIWAN) || locale.equals(Locale.TRADITIONAL_CHINESE))
        {
            localeName = "zh";
        }
