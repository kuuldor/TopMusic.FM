...
import the.topmusic.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    /*
     * (non-Javadoc)
     * @see the.topmusic.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
     ...
     * @return A new color from TopMusic's resources.
     */
