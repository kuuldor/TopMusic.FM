...
public class ProfileTabCarousel extends HorizontalScrollView implements OnTouchListener {
    ...
    protected void onLayout(final boolean changed, final int l, final int t, final int r,
        ...
        TopMusicUtils.doAfterLayout(this, new Runnable() {
            @Override
            public void run() {
    ...
    public CarouselTab resetTabAtIndex(final int tabIndex) {
        moveToYCoordinate(tabIndex, 0);
        return getTabAtIndex(tabIndex);
    }
    ...
    public CarouselTab getTabAtIndex(int index) {
        final CarouselTab selected;
    ...
    public CarouselTab getCurrentTab() {
        final CarouselTab selected;
        ...
        switch (mCurrentTab) {
            ...
            case TAB_INDEX_SECOND:
                ...
                break;
            default:
                throw new IllegalStateException("Invalid tab position " + mCurrentTab);
        }
        return selected;
    }
    ...
    public void setOnlineArtistProfileHeader(final SherlockFragmentActivity context,
                                             final Bundle args) {
        mFirstTab.setLabel(getResources().getString(R.string.page_albums));
        mSecondTab.setLabel(getResources().getString(R.string.page_hotsongs));
        String imageURL = args.getString("imageURL");
        mFirstTab.setURLPhoto(context, imageURL);
        mEnableSwipe = true;
    }
    ...
    public void setChartProfileHeader(final SherlockFragmentActivity context,
                                      final Bundle args) {
        mFirstTab.setDefault(context);
        mFirstTab.setLabel("");
        String imageURL = args.getString("imageURL");
        mFirstTab.setURLPhoto(context, imageURL);
        mSecondTab.setLabel(getResources().getString(R.string.page_charts));
        mFirstTab.setURLPhoto(context, imageURL);
        mEnableSwipe = false;
    }
    ...
    public void setOnlineAlbumProfileHeader(final SherlockFragmentActivity context, Bundle args) {
        mFirstTab.setLabel(getResources().getString(R.string.page_songs));
        String imageURL = args.getString("imageURL");
        mFirstTab.setAlbumPhotoWithURL(context, imageURL);
        mSecondTab.setVisibility(View.GONE);
        mEnableSwipe = false;
    }
