...
public final class Config {
    ...
    public static final String CHART_URL_PATH = "/top100/listdir/type=topcatigories";
    public static final String ARTIST_URL_PATH = "/xiami/listdir/type=artistregions";
    public static final String ALBUM_URL_PATH = "/xiami/listdir/type=albumregions";
    public static final String GENRE_URL_PATH = "/xiami/listdir/type=topgenres";
    public static final String SEARCH_URL_PATH = "/xiami/search/type=%s&keyword=%s";
    public static final String ENTITY_URL_PATH = "/xiami/getEntity/kind=%s&%s=%s";
